...
""" 
lower   = [6.0,  0.45, 25.0,      10000.0,    0.65,  0.1,   0.125,    0.125,    0.9,  0.7,  1400.0, 10.0,  1.25,   2.999,   1.0]
upper   = [18.0, 0.75, 30.0,      20000.0,    0.85,  0.4,   0.15,     0.15,     1.3,  1.0,  1650.0, 15.0,  2.0,    3.001,  20.0]
init_dx = [0.5,  0.05,  0.1,       200.0,     0.01,  0.01,  0.01,     0.01,     0.01, 0.01, 100.0,   0.5,  0.05,   0.0001  ,1.0]
initial = [
