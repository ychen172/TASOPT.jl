...
caseKeys   = ["Opti_Jet_NoACT_",   "Opti_Eth_NoACT_",  "Opti_Jet_Thin_NoACT_", "Opti_Eth_Dense_NoACT_"]
caseNames  = ["Jet Fuel Baseline", "Ethanol Baseline", "Thinner Jet Fuel",     "Denser Ethanol"]
idxMiss    = [1,1,1,1]
ranges     = collect(300:100:3000) 
# Output directory
save_dir      = "../ModelProcessed"
save_name     = "Special_diagnostic_fuel" #sub_folder will be created
# Fields to read out
const fields = (:range_nmi,:PFEI_JJ,:lenFuseCyl_m,:FuelVolumeFractionACT,:lenACT_m,:volFuelTot_m3,:massEmpty_Ton,
                :massFuelTot_Ton,:massPayload_Ton,:ene_fli_J,:volFuelMax_m3,:FuelVolumeFraction,:massTO_Ton)
