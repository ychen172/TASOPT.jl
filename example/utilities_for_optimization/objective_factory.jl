...
Use the corresponding constructor for it as additional field_path needs to be generated when constructed
"""
mutable struct Requirement{T<:Union{Real,Enum,AbstractArray{<:Real},AbstractArray{<:Enum}}}
...
Requirement(name::Expr, val::Union{Real,Enum,AbstractArray{<:Real},AbstractArray{<:Enum}})
...
"""
function Requirement(name::Expr, val::Union{Real,Enum,AbstractArray{<:Real},AbstractArray{<:Enum}})
    field_path, index = format_params(expr_to_string(name))
...
function optimize_singlePt_PFEI!(ac, optimize_par::AbstractVector{<:Parameter} ;
    ...
    (; obj!, hist) = make_obj(ac, optimize_par ; objVar_des=objVar_des, objVar_off=objVar_off, constraints=constraints, print_every=print_every,
